...
exports.generateThumbnail = functions.storage.object().onFinalize(async (object) => {
  ...
  // note : not sure if still necessary
  ...
  const metadata = { contentType: contentType, 'Cache-Control': 'public,max-age=3600'};
  ...
  await spawn('convert', [tempLocalFile, '-auto-orient', '-normalize', '-thumbnail', `${THUMB_MAX_WIDTH}x${THUMB_MAX_HEIGHT}>`, tempLocalThumbFile], {capture: ['stdout', 'stderr']});
